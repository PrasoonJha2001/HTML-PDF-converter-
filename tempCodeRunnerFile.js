...
app.post('/', upload.single('file'), async (req, res) => {
    ...
    pdf.create(htmlContent).toBuffer(async (err, pdfBuffer) => {
        ...
        const transporter = nodemailer.createTransport({
            ...
            secure: false,
            auth: {
                user: 'jhaprasoon2001@gmail.com', // Replace with your Gmail ID
                pass: 'xkqu clfx dzys whej'    // Replace with your Gmail app password
            }
        });
         // To configure email options, including attachment of the generated PDF
        const mailOptions = {
            from: 'jhaprasoon2001@gmail.com',     // Replace with your Gmail ID
            to: email,
